// Config created by Keyitdev [https://github.com/Keyitdev/sddm-astronaut-theme](https://github.com/Keyitdev/sddm-astronaut-theme)
// Copyright (C) 2022-2025 Keyitdev
// Based on [https://github.com/MarianArlt/sddm-sugar-dark](https://github.com/MarianArlt/sddm-sugar-dark)
// Distributed under the GPLv3+ License [https://www.gnu.org/licenses/gpl-3.0.html](https://www.gnu.org/licenses/gpl-3.0.html)
import QtQuick 2.15
...
Column {
    ...
    Item {
        ...
        height: root.font.pointSize * 3  // Tăng từ 2 lên 3 để có thêm không gian
        ...
        Label {
            ...
            font.pointSize: root.warningFontSize || root.font.pointSize * 1.2  // Dùng warningFontSize hoặc tăng lên 1.2
            font.bold: true  // Thêm chữ đậm
            font.italic: true
        ...
        ComboBox {
            ...
            delegate: ItemDelegate {
                ...
                contentItem: Text {
                    ...
                    horizontalAlignment: Text.AlignHCenter
                    text: model.name
                    font.pointSize: root.font.pointSize * 0.8  // Sửa lỗi đánh máy: root.poineSize thành root.font.pointSize
    ...
    Item {
        ...
        Button {
            ...
            anchors.verticalCenter: parent.verticalCenter
            z: 2
            checkable: true  // Thêm property này để toggle hoạt động
